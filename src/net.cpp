...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Czechcrowncoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    ...
    {"seed1.czechcrowncoin.com", "seed1.czechcrowncoin.com"},
    {"seed2.czechcrowncoin.com", "seed2.czechcrowncoin.com"},
    {"seed3.czechcrowncoin.com", "seed3.czechcrowncoin.com"},
    {"czechcrowncoin.com", "czechcrowncoin.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
//    {"czechcrowncoin.no-ip.biz", "testnet-dnsseed.czechcrowncoin.no-ip.biz"},
    {"czechcrowncoin.com", "testnet.czechcrowncoin.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Czechcrowncoin is probably already running."), addrBind.ToString().c_str());
        else
